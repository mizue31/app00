...
class SoftwaresControllerTest < ActionController::TestCase
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post :create, software: { eos_date: @software.eos_date, maker: @software.maker, sw_name: @software.sw_name, version: @software.version }
    end
  ...
  test "should update software" do
    put :update, id: @software, software: { eos_date: @software.eos_date, maker: @software.maker, sw_name: @software.sw_name, version: @software.version }
    assert_redirected_to software_path(assigns(:software))
  end
